...
dataset_file = "properties_rent_{{ execution_date.strftime(\'%Y%m\') }}.csv"
bq_table_id = "properati-data-public.properties_br.properties_rent_{{ execution_date.strftime(\'%Y%m\') }}"
...
with DAG(
    dag_id="rent_data_ingestion_dag",
    ...
    load_csv = GCSToBigQueryOperator(
        ...
        destination_project_dataset_table=f"{BIGQUERY_DATASET}.rent_data_external_table",
